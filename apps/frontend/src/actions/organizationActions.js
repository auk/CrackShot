...
function createRequestParamsActions(name) {
  return createActions({
    ...
    [ name + '_SUCCESS' ]: null, // payload => payload,
    [ name + '_ERROR' ]: null // error => ({...error})
  });
}
...
export const { createOrganization, createOrganizationSuccess, createOrganizationError } = createRequestParamsActions('CREATE_ORGANIZATION');
